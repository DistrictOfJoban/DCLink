...
public class MinecraftMessages {
    ...
    {
        BridgePlaceholder placeholder = new BridgePlaceholder(message, channel, com.lx.dclink.data.bridge.Member.fromDiscord(guildMember), null);
    ...
    public MutableText getDiscordEditedMessage(Message oldMessage, Message newMessage, StandardGuildChannel channel, Member guildMember) {
        BridgePlaceholder placeholder = new BridgePlaceholder(null, channel, com.lx.dclink.data.bridge.Member.fromDiscord(guildMember), null);
    ...
    public List<MutableText> getAttachmentText(List<Message.Attachment> attachmentList, StandardGuildChannel channel, Member guildMember) {
        ...
        for(Message.Attachment attachment : attachmentList) {
            BridgePlaceholder placeholder = new BridgePlaceholder(null, channel, com.lx.dclink.data.bridge.Member.fromDiscord(guildMember), attachment);
    ...
    public MutableText getReactionAddMessage(String emoji, StandardGuildChannel channel, Member reactMember, Member messageMember, Message reactedMessage) {
        BridgePlaceholder placeholder = new BridgePlaceholder(reactedMessage, channel, com.lx.dclink.data.bridge.Member.fromDiscord(reactMember), null);
        placeholder.addPlaceholder("emojiID", emoji);
        placeholder.addPlaceholder("emoji", emoji);
        placeholder.setData("author", com.lx.dclink.data.bridge.Member.fromDiscord(messageMember));
